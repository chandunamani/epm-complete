...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onThePurchaseOrdersList.onTable().iCheckColumns(undefined, {"poNumber":{"header":"PO Number"},"status":{"header":"Status"},"priority":{"header":"Priority"},"totalAmount":{"header":"Amount"},"orderDate":{"header":"Order Date"}});
